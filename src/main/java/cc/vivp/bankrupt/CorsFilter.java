...
public class CorsFilter implements Filter {
    ...
    public static final String HEADER_VALUE_ALLOWED_METHODS = "GET, POST, OPTIONS, DELETE, PUT, HEAD, PATCH";
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (null != httpRequest.getHeader(HEADER_ORIGIN)) {
            ...
            httpResponse.addHeader(HEADER_ALLOWED_HEADERS, httpRequest.getHeader(HEADER_REQUEST_HEADERS));
